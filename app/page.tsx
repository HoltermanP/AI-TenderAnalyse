...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-primary text-foreground overflow-x-hidden">
      {/* Navigation */}
      <nav className="border-b border-border-subtle bg-surface-glass backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="text-xl font-bold font-grotesk">
            <span className="text-blue-light">AI</span>
            <span className="text-foreground">-TenderAnalyse</span>
          </div>
          <Link
            href="/dashboard"
      ...
      <section className="max-w-7xl mx-auto px-6 pt-24 pb-16 text-center">
        <div className="inline-flex items-center gap-2 bg-surface border border-border-subtle rounded-full px-4 py-1.5 text-sm text-muted mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 border border-foreground/20 hover:border-foreground/40 text-foreground font-semibold px-8 py-4 rounded-md transition-colors text-lg"
          >
            Bekijk tenders
          </Link>
        </div>
      ...
      <footer className="border-t border-border-subtle mt-16">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-xl font-bold font-grotesk">
            <span className="text-blue-light">AI</span>
            <span className="text-foreground">-Group.nl</span>
          </div>
